...
$query_select = mysqli_query($con,"SELECT * FROM devolucion");
  ...
  <div class="container space-2 space-3-top--lg space-2-bottom--lg">
      <div class="row">
        ...
        <div class="col-lg-12 order-lg-1">
          <!-- Checkout Form -->
          <form class="form-horizontal" method="post" id="guardar_devolucion" name="guardar_devolucion"><!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Devoluciones</span> <!-- titulo del formulario en texto-->
              </li>
            </ul>
            ...
            <div id="stepFormContent">
              ...
              <div id="formNuevoAsesor" class="active"> <!-- asigna un id al bloque donde estan los campos de nuevo asesor proveedor-->
                ...
                <div class="col-md-4">
                  ...
                  <div class="js-form-message mb-6">
                    ...
                    <div class="js-focus-state input-group form">
                      <input type='button' class="btn btn-facebook btn-s text-center"   value="Cambiar Producto"  id="cambiarProducto" name="cambiarProducto"></input>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                      <input type='button' class="btn btn-facebook btn-s text-center"   value="Intercambiar Producto" name="intercambiarProducto" id="intercambiarProducto"></input>
                      </div>
                    </div>
                    <!-- End Input -->
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                      <input type='button'  class="btn btn-facebook btn-s text-center"   value="Devolver Producto" name="devolverProducto" id="devolverProducto"></input>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                      <input type='button'  class="btn btn-facebook btn-s text-center"   value="Listar Devoluciones" name="listarDevoluciones" id="listarDevoluciones"></input>
                      ...
                      <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaDevoluciones">
                          <thead >
                              <tr class="bgcolor btn-facebook">									
                                  ...
                                  <th class="text-center">Cod Devolucion</th>
                          ...
                          ?>          
                                    ...
                                    <tr>
                                    <td class="text-center"><?php echo $row['iddevolucion']?></td>
                                    <td><?php echo $row['fechadevolucion']?></td>
                                    <td><?php echo $row['movimientodevolucion']?></td>
                ...
                <div id="contenedorTablaVentas" style="display: none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" class="tab-content-center d-flex justify-content-center " >
                      
                      <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaVentas">
                          <thead >
                              <tr class="bgcolor btn-facebook">									
...
<?php
            //  include("modal/modalprueba.php") ; // modal que permite Guardar el usuario
             include("modal/modalDevoluciones.php") ;// modal que permite Guardar el usuario
  ...
  <script type="text/javascript" src="js/devoluciones.js">  </script>    <!--agrega loa archivos a los que mandara informacion en el js -->
