...
?>
	...
	<!-- Modal -->
	<div class="modal fade" id="Modal_Edit_Proveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 	<!-- etiqueta y de id al modal -->
      ...
      <button type="button" id="cerrar" class="close" data-dismiss="modal" aria-label="Close"><span id="span" aria-hidden="true">&times;</span></button>
		  ...
		  <form class="form-horizontal" method="post" id="editar_Proveedor" name="editar_Proveedor"> 	<!-- le da un id al formulario de editar para realizar post -->
			  ...
			  <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
				...
				<li class="list-inline-item u-shopping-cart-step-form__item mb-3">
				  <img class="max-width-10 mx-auto mb-2" src="../../img/setting.svg" alt="Image Description">
				...
				<div id="nuevapersona" class="active">
				  ...
				  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="pnombre2" id="pnombre2" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="snombre2" id="snombre2"
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="papellido2" id="papellido2" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="sapellido2" id="sapellido2"
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="number" name="cui2" id="cui2" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" name="fecha2" id="fecha2" type="date" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="usuario2" id="usuario2" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="email" name="email2" id="email2"  required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="password" name="pass2" id="pass2" required
                ...
                <div class="w-100"></div>
                    ...
                    <div class="col-md-6">
                        <div class="js-form-message mb-6">
                            ...
                            <div class="js-focus-state input-group form">
                             <input class="form-control form__input" type="text" name="dir2" id="dir2" required
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" name="telefono2" id="telefono2" type="number"
