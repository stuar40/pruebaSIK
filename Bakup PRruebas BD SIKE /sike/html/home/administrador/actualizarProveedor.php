  ...
  <div class="container space-2 space-3-top--lg space-2-bottom--lg">
      <div class="row">
        ...
        <div class="col-lg-12 order-lg-1">
          <!-- Checkout Form -->
          <form class="form-horizontal" method="post" id="editar_Proveedor" name="editar_Proveedor">  <!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Editar a Proveedor</span>  <!-- titulo del formulario en texto-->
              </li>
            </ul>
            ...
            <div id="stepFormContent">
              ...
              <div id="newproveedor" class="active">  <!-- asigna un id al bloque donde estan los campos de nuevo proveedor-->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <!-- Input -->
                     <!-- Input 2 segundo bloque ingreso de ID del proveedor -->
                     <div class="js-form-message mb-6">
                      <label class="h6 small d-block text-uppercase"> <!-- etiqueta del campo de texto  donde se almacena el ID  del proveedor -->
                      ID del Proveedor
                      <span class="text-danger">*</span>
                      </label>
                      <div class="js-focus-state input-group form">
                        <input class="form-control form__input" type="text" name="idProveedor" id="idProveedor" required
                              minlength="1" maxlength="12"
                               placeholder="Ingrese ID del proveedor"> <!-- se asignan identificadores y detalles al campo de texto del ID   del proveedor -->
                      </div>
                    </div>
                    <!-- End Input -->
                    <!-- End Input -->
                ...
                <!-- End Billing Form -->
                <input  type="text" name="action" id="action" value="editar_Proveedor" hidden>
                ...
                <input type="submit" class="btn btn-facebook btn-xs text-center"  data-next-step="agregar" value="Editar Datos" name="insertar"></input>
