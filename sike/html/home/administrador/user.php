          ...
          <!-- Checkout Form -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Administración de Usuarios</span>
              </li>
            </ul>
...
<div class="col-12 mb-5 ">
    ...
    <input type="search " id="txtSearch" class="form-control " placeholder="usuario / nombre" aria-label="Search">

<label for="buscar">Filtrar por sucursal:</label>
  <input type="search " id="txtSearch2" class="form-control " placeholder="numero" aria-label="Search2">
    </div>
    ...
    <div id="myTabContent" class="tab-content-center d-flex justify-content-center ">
                    ...
                    <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tblUsuarios">
                            ...
                            <th class="text-center">No. Sucursal</th>
