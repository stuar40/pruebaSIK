...
$query_select = mysqli_query($con, "SELECT p.id,p.sku, p.nombre,p.descripcion,p.presentacion,p.marca,c.nombre as categoria,s.nombre as subcategoria, e.estado FROM producto p
              ...
              <div class="col-12 mb-5 ">
                <nav class="navbar navbar-light bg-light">
                  ...
                  <div class="col-6 mb-1 " class="form-inline">
                    <input type="submit" class="btn btn-facebook btn-md text-center" class="form-control " data-next-step="Crear" id="nuevoProducto" value="Nuevo Producto (+)" name="nuevoProducto"></input>
                  </div>
                          ...
                          <td>
                            <div class="text-center">
                              <div class="btn-group btnPro">
                                ...
                                <a href="#" onclick="obtener_datos('<?php echo $row['id']  ?>');" data-toggle="modal" data-target="#Modal_editarProductos" class="btn btn-warning btn-xs"> <i class="fa fa-edit"></i>
                          </td>
