...
$query_select = mysqli_query($con,"SELECT c.id, c.fecha, c.status,c.factura,c.totalcompra,concat(s.numero,' ',s.direccion) AS sucursal,e.nombre,u.nombre_usuario FROM comprarecarga c INNER JOIN sucursal s
ON c.sucursal_idsucursal = s.id
INNER JOIN empresa e ON e.id = c.empresa
INNER JOIN usuarios u ON u.id = c.usuarios_idusuarios
ORDER BY c.id asc");
          ...
          <!-- Checkout Form -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Compra de Recargas</span>
                  ...
                  <div class="col-md-2" >
                     ...
                     <label class="h6 small d-block text-uppercase">
                       ...
                       <span class="text-danger">*</span>
                        ...
                        <input class="btn btn-success  text-center" type="submit" value="Procesar"  id="procesar" name="procesar">
 </div>
 </div>   
...
<table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaComprasr">
  <thead>
...
?>
  ...
  <script type="text/javascript" src="js/comprasr.js">  </script> 
