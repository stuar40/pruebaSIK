      ...
      <div class="col-lg-12 order-lg-1">
        ...
        <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
          ...
          <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
            ...
            <span class="u-shopping-cart-step-form__title">Ventas Recargas</span>
          </li>
        </ul>
...
$query_select2 = mysqli_query($con, "SELECT e.numfactura, e.fecha,e.totalfactura,concat(c.nombre,' ',c.apellido) as cliente,c.nit , usuarios.nombre_usuario
FROM encabezado_venta e INNER JOIN clientes c ON c.id = e.clientes_id 
INNER JOIN usuarios on usuarios.id = e.usuarios_idusuarios WHERE sucursal_idsucursal =  $Intid");
  ...
  <tbody>
    ...
    ?>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo $row2['fecha'] ?></td>
          <td class="text-center"><?php echo $row2['totalfactura'] ?></td>
          <td class="text-center"><?php echo $row2['cliente'] ?> </td>
          <td class="text-center"><?php echo $row2['nit'] ?> </td>
          <td class="text-center"><?php echo $row2['nombre_usuario'] ?> </td>
