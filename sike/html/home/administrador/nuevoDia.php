...
<body class="responsive-mode">
 ...
 <!-- ========== MAIN CONTENT contenido principal del formulario nueva empresa ========== -->
  ...
  <div class="container space-2 space-3-top--lg space-2-bottom--lg">
      <div class="row">
        ...
        <div class="col-lg-12 order-lg-1">
          <!-- Checkout Form -->
          <form class="form-horizontal" method="post" id="Formguardar_NuevoDia" name="Formguardar_NuevoDia">  <!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Inicio del día</span>  <!-- titulo del formulario en texto-->
              </li>
            </ul>
            ...
            <div id="stepFormContent">
              ...
              <div id="newegreso" class="active">  <!-- asigna un id al bloque donde estan los campos de nuevo proveedor-->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      ...
                      <select class="custom-select" name="SeleccionSucursal" id="SeleccionSucursal" required > 
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="js-form-message mb-6">
                      <label class="h6 small d-block text-uppercase"><!-- etiqueta del campo de texto  donde se ingresa la direccion comercial del proveedor -->
                        Monto de Inicio de Día
                        <span class="text-danger">*</span>
                      </label>

                      <div class="js-focus-state input-group form">
                      <input  class="form-control form__input" type="text" name="montoDia" id="montoDia" required
                ...
                <!-- End Billing Form -->
                <input  type="text" name="action" id="action" value="guardarDia" hidden>
                <input  type="text" name="intencion" id="intencion" value="guardarDia" hidden>
                <!-- Buttons -->
  ...
  <script type="text/javascript" src="js/jquery.min.js">  </script> 
   <script type="text/javascript" src="js/nuevoDia.js">  </script> 
