...
$query_select = mysqli_query($con,"SELECT fecha,descripcion,monto, nombre_usuario,sucursal.direccion as nombresucursal FROM egresos inner join usuarios on egresos.usuarios_id=usuarios.id  inner join sucursal on egresos.sucursal_id=sucursal.id ");
          ...
          <!-- Checkout Form -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Listado de Egresos Economicos</span>
              </li>
            </ul>
...
<!-- Busqueda -->
              ...
              <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" class="tab-content-center d-flex justify-content-center " >
                    ...
                    <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaListaEgresosEconomicos">
                        <thead >
