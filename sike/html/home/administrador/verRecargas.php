...
$query_select = mysqli_query($con,"SELECT cat.nombre AS categoria,e.nombre as empresa,  s.saldo, concat(suc.numero,' ',suc.direccion) as sucurs 
FROM saldo s INNER JOIN recarga ON recarga.idrecarga = s.recarga_id 
INNER JOIN empresa e ON e.id = recarga.empresa_id
INNER JOIN sucursal suc ON suc.id = s.sucursal_id
INNER JOIN categoria cat ON recarga.categoria_id = cat.id");
              ...
              <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" class="tab-content-center d-flex justify-content-center " >
                    ...
                    <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaRecargas">
                        ...
                        ?>          
                                  ...
                                  <td class="text-center"><?php echo $row['sucurs']?> </td>
