 ...
 <!-- ========== MAIN CONTENT ========== -->
  ...
  <div class="card card-frame mb-7">
    ...
    <a class="card-body p-4" href="newuser.php">
      <div class="media">
        <img class="max-width-12 mb-2" src="../../img/egresos.svg" alt="Image Description">
        <div class="media-body px-3">
          <h4 class="h6 text-dark mb-2">Egresos</h4>
          <p class="mb-0">Nuevo Egreso</p>
        </div>
      </div>
    </a>
    <!-- End Listing -->
    ...
    <a class="card-body p-4" href="#">
      <div class="media">
        <img class="max-width-12 mb-2" src="../../img/venta.svg" alt="Image Description">
        <div class="media-body px-3">
          <h4 class="h6 text-dark mb-1">Venta</h4>
          <p>Nueva Venta</p>
        </div>
      </div>
    </a>
  ...
  <div class="card card-frame mb-7">
    ...
    <a class="card-body p-4" href="#">
      <div class="media">
        <img class="max-width-12 mb-2" src="../../img/inventario.svg" alt="Image Description">
        <div class="media-body px-3">
          <h4 class="h6 text-dark mb-1">Stock</h4>
          <p>Inventario en Sucursal</p>
        </div>
      </div>
    </a>
    <!-- End Listing -->
