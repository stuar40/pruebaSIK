...
if ($dpi > 0) {
    ...
    $sql="INSERT INTO `usuarios` (`pnom`, `snom`, `pape`, `sape`, `nacimiento`, `nombre_usuario`,
...
if(isset($_POST['action']) == 'editar_usuario'  AND !empty($_POST['id_usu'])){
    ...
    # code...
  $sql = " UPDATE `protec_db`.`usuarios` SET `pnom` = '$n1', `snom` = '$n2', `pape` = '$n3', 
