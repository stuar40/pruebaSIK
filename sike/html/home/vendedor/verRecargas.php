...
$query_select = mysqli_query($con,"SELECT idrecarga, categoria.nombre as categoria, empresa.nombre as empresa , monto FROM recarga
INNER JOIN empresa on empresa.id = recarga.empresa_id 
INNER JOIN categoria on categoria.id = recarga.categoria_id;");
          ...
          <!-- Checkout Form -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Administración de Recargas</span>
              </li>
            </ul>
...
<!-- Busqueda -->
              ...
              <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" class="tab-content-center d-flex justify-content-center " >
                    ...
                    <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaRecargas">
                        ...
                        ?>          
                                  ...
                                  <tr>
                                  <td class="text-center"><?php echo $row['idrecarga']?></td>
                                  ...
                                  <td>
                                    ...
                                    <div class="btn-group btnPro" >

             <a href="#" onclick="obtener_datos('<?php echo $row['idrecarga']  ?>');" data-toggle="modal" data-target="#Modal_editarSaldo"
             class="btn btn-warning btn-xs"> <i class="fa fa-edit"></i> </td>
  ...
  <!-- ========== LLama a ventanas Modales ========== -->
        <?php
             include("modal/editarSaldo.php") ; // modal que permite Guardar el usuario
