...
$query_select = mysqli_query($con,"SELECT id, nombre, apellido, nit, telefono, direccion, correo FROM clientes  ORDER BY id asc");
          ...
          <!-- Checkout Form -->
            ...
            <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
              ...
              <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
                ...
                <span class="u-shopping-cart-step-form__title">Administración Cliente</span>
              </li>
            </ul>
...
<!-- Busqueda -->
    <div class="col-12 mb-5 ">
              ...
              <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" class="tab-content-center d-flex justify-content-center " >
                    <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaClientes">
                        <thead >
                        ...
                        ?>          
                                  ...
                                  <td class="text-center"> <a href="#" onclick="obtener_datos('<?php echo $row['id']  ?>');" data-toggle="modal" data-target="#Modal_editarProductos"
  ...
  <!-- ========== LLama a ventanas Modales ========== -->
        <?php
             include("modal/editar_Cliente.php") ; // modal que permite Guardar el usuario
