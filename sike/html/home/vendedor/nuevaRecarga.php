...
<body class="responsive-mode">
        ...
        <form class="form-horizontal" method="post" id="guardar_saldo" name="guardar_saldo">
          ...
          <ul id="stepFormProgress" class="js-step-progress list-inline u-shopping-cart-step-form mb-4">
            ...
            <li class="list-inline-item u-shopping-cart-step-form__item mb-3">
              ...
              <span class="u-shopping-cart-step-form__title">Monto Inicial</span>
            </li>
          </ul>
          ...
          <div id="stepFormContent">
            <!-- Customer Info -->
            <div id="nuevosaldo" class="active">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <div class="js-form-message mb-6">
                    <label class="h6 small d-block text-uppercase">
                      Monto
                      <span class="h10 small">*</span>
                    </label>
                    <div class="js-focus-state input-group form">
                      <input class="form-control form__input" type="number" name="dinero" id="dinero" placeholder="Ingrese el monto de compra" required>
                    </div>
                  </div>
                  <!-- End Input -->
                </div>
              ...
              <!-- End Billing Form -->
              <input type="text" name="action" id="action" value="agregar_saldo" hidden>
  ...
  <script>
  bootstrapValidate('#dinero','numeric:Ingrese un monto correcto')
